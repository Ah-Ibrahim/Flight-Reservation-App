...
const getFlightSpecialEndpoint = import.meta.env.VITE_GET_FLIGHT_SPECIAL_ENDPOINT;
const addFlightsEndpoint = import.meta.env.VITE_ADD_FLIGHT_ENDPOINT;
const deleteFlightEndpoint = import.meta.env.VITE_DELETE_FLIGHT_ENDPOINT;
...
function AdminFlights() {
	...
	const fetchFlights = async () => {
		...
		try {
			const res = await fetch(getFlightSpecialEndpoint);
	...
	const handleAddFlight = async (e) => {
		...
		try {
			const res = await fetch(addFlightsEndpoint, {
				method: 'POST',
	...
	const handleDeleteFlight = async (FlightID) => {
		...
		try {
			const res = await fetch(deleteFlightEndpoint, {
				method: 'POST',
				headers: { 'Content-Type': 'application/json' },

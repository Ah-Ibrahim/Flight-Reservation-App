...
function AdminLogin() {
  ...
  try {
    ...
    const res = await fetch('http://localhost/sw_project/get_admin.php', {
      method: 'POST',
    ...
    if (error.name === 'TypeError') {
      console.error('This usually means the fetch failed to reach the server. Is the server running and reachable?');
    }
  }
};
